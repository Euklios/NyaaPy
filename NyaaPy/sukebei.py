...
class SukebeiNyaa:
    ...
    def search(self, keyword, **kwargs):
        ...
        request_url = "{}/?f={}&c={}_{}&q={}".format("http://sukebei.nyaa.si", filters, category, subcategory, keyword)
        if page > 0:
...
class SukebeiPantsu:
    ...
    def login(self, username, password):
        ...
        login = requests.post("{}/login/".format(SukebeiPantsu.BASE_URL), data=login_data)
